...
import { ConversationContainer, MessageInput, MessagesContainer, SendMessageContainer } from './ConversationElements';
    ...
    <ConversationContainer>
      ...
      {messages &&
       ...
       <SendMessageContainer onSubmit={sendMessage} >
        <MessageInput placeholder="Napisz wiadomość" type="textarea" value={inputMessage} onChange={(e) => setInputMessage(e.target.value)}/>
